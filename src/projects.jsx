...
<div className=" flex w-full h-17 bg-gray-900 justify-center shadow-lg border-b border-gray-400">
    ...
    <div className="w-full h-70  mt-8">
      ...
      <div className="w-full h-20 flex mt-7 gap-2 pl-4">
        <button className="bg-blue-400 w-30 h-13 border-2 border-blue-400 hover:bg-blue-700 hover:border-blue-700 rounded-xl text-white">Join Now !</button>
        <button className="bg-gray-500 w-45 h-13 border-2 border-gray-500 hover:bg-gray-700 hover:border-gray-700 rounded-xl text-white">Last session winners</button>
      </div>
    </div>
